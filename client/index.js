...
const handleSubmit = async () => {
    ...
    location.replace('/client/Public/library.html');
}
...
const openLibrary = async () => {
    ...
    Object.entries(data).forEach((book, index) => {
        ...
        cardStyle.value = "width: 18rem; height: auto;"
        ...
        bookImgSrc.value = book.Image || "/client/Public/logo.jpeg";
...
const handleDelete = async (event) => {
    ...
    await axios.delete(`http://localhost:3000/books/${book[0]}`);
...
const handleUpdate = async () => {
    ...
    await axios.patch(`http://localhost:3000/books/${title}`, data);
